...
export const StatsCards: React.FC<StatsCardsProps> = ({ analytics }) => {
  ...
  const stats = [
    ...
    },
    {
      ...
      subtext: 'all-time focus',
      tooltip: 'Cumulative focus time since you started using the app',
    },
    {
      label: 'Avg Daily',
      ...
      tooltip: 'How much focus time you typically get in a day. Calculated by total focus time divided by the number of days you\'ve used the app.',
    },
    {
      label: 'Completed',
